...
live_loop :theremin_control do
  ...
  vibrato_rate: 3,
    vibrato_depth: 0.1,
    portamento: 0.02        # Pequeno tempo para "escorregar" entre as notas (em segundos)
  
  # Removi o sample :elec_blip para um som mais limpo e focado no theremin.
  
  sleep 0.1 # Pequeno delay
end